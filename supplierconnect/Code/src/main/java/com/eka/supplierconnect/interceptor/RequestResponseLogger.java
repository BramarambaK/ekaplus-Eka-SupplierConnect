...
public class RequestResponseLogger {
	...
	@AfterReturning("execution(* com.eka.supplierconnect..controller..* (..))")
	...
	@AfterReturning(value = "execution(* com.eka.supplierconnect..controller..* (..))", returning = "result")
	...
	@AfterThrowing(value = "execution(* com.eka.supplierconnect..controller..* (..))", throwing = "e")
